...
import { MutabakatOnayForm } from '@/components/mutabakat-onay-form'
...
export default async function MutabakatOnayPage({
  params,
}: {
  ...
  const itirazUrl = `/mutabakat/itiraz/${encodeURIComponent(token)}`
