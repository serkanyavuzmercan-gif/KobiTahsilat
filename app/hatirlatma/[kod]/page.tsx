    ...
    <div className="space-y-5">
      ...
      <section className="overflow-hidden rounded-2xl border border-emerald-200 bg-white shadow-sm">
        <div className="border-b border-emerald-100 bg-emerald-50 px-4 py-3">
          ...
          <p className="text-xs text-emerald-700">Kibar ödeme hatırlatması · mutabakat metni değildir</p>
        </div>
        <pre className="whitespace-pre-wrap p-5 text-sm leading-relaxed text-slate-800">
          {message.body}
        </pre>
      </section>
    </div>
